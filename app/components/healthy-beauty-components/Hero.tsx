...
const Hero = ({ condition }: { condition?: any }) => {
  ...
  return (
    <>
      ...
      >
        <div className="relative max-w-7xl  mx-auto flex flex-col md:flex-row items-center">
          <div className="relative  z-10 w-full md:w-1/2 lg:w-2/5 p-4">
            <div className="bg-white p-6 rounded-lg shadow-lg md:mt-20 md:h-70">
      ...
      <div className="flex justify-center  items-center lg:bg-[#F8F8F8] container  mx-auto w-[80%] sm:bg-transparent md:bg-transparent  ">
