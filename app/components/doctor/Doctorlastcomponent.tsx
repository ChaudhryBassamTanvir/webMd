  ...
  return (
    ...
    <div className="bg-[#F5F5F5] flex justify-center items-center">
      <div className="mx-10 pt-5">
        <Link
          href={"/"}
          className="text-blue-500 flex items-center text-[16px] hover:underline mt-1"
        >
          Find Doctors
          <IoIosArrowForward />
        </Link>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-5 gap-10">
            <div>
              <div>
                <Link
                  href={"/"}
                  className="text-[#0078BF] hover:underline font-semibold"
                >
                  ...
                  {Slist?.map((specialty, index) => (
                    <div key={index} className="mt-[4px]">
                      <Link href={specialty.slug}>
                        <span className="text-[14px] hover:underline text-black">
                          {specialty.title}
                        </span>
                      </Link>
                    </div>
              ...
              {/* <div>
                <div className="flex-1 mt-2">
                  {ProList?.map((specialty, index) => (
                    <div key={index} className="mt-[4px]">
                      <Link href={specialty.slug}>
                        <span className="text-[14px] hover:underline text-[#0078BF]">
                          {specialty.title}
                        </span>
                      </Link>
                    </div>
