...
const DetailSection = ({ headingStyle }: UsesSectionProps) => {
  return (
   ...
   <div className="text-center flex justify-center">
      ...
      <p className='text-[#1b1b1b] font-sans '>This medication is used to treat certain mental/mood disorders (such as bipolar disorder, schizophrenia, Tourette's syndrome, and irritability associated with autistic disorder). It may also be used in combination with other medication to treat depression. Aripiprazole belongs to a class of drugs known as atypical antipsychotics. It works by helping to restore the balance of certain natural substances in the brain.</p>
     <div className='m-4 flex justify-start items-start'>
     <strong className='text-[#1b1b1b] text-2xl font-sans'>How to use Abilify</strong>
     </div>
      <p>TRead the Medication Guide and, if available, the Patient Information Leaflet provided by your pharmacist before you start taking aripiprazole and each time you get a refill. If you have any questions, ask your doctor or pharmacist.
...
If you are using the liquid form of this medication, carefully measure the dose using a special measuring device/cup. Do not use a household spoon because you may not get the correct dose.</p>
    </div>
  );
};
